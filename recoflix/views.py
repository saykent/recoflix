...
def index(request):
    ...
    return render(request, 'recoflix/index.html', context_dict)
...
def detail(request, movie_id):
    ...
    return render(request, 'recoflix/detail.html', context_dict)
...
def search_for_movie(request):
    ...
    return render(request, 'recoflix/search_result.html', context_dict)
